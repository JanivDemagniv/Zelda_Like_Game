...
class Item():
    ...
    def display(self, display_surface,selection_number,name,value,max_value,cost):
        if self.index == selection_number:
            ...
            pygame.draw.rect(display_surface,UI_BORDER_COLOR,self.rect,4)
        self.display_name(display_surface,name,cost,self.index == selection_number)
        self.display_bar(display_surface,value,max_value,self.index == selection_number)